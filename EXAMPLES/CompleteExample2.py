...
Parser = ParserTemplateEngine(("_StArT_", "_eNd_"), "_StArT_self.FUNC_CALL()_eNd_");
Settings = Parser.ParseEntryPoint("html_plot - SR2/template_index.html");
...
Filler = FillerTemplateEngine(("_StArT_", "_eNd_"), "_StArT_self.FUNC_CALL()_eNd_");
FilledString = Filler.FillEntryPoint(Settings, "html_plot - SR2/template_index.html", "html_plot - SR2/index.html");

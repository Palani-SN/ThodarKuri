...
Parser = ParserTemplateEngine(("{\\[<{\\[", "}\\]>}\\]"), "{[<{[self.FUNC_CALL()}]>}]");
Settings = Parser.ParseEntryPoint("html_plot - SR5/template_index.html");
...
Filler = FillerTemplateEngine(("{\\[<{\\[", "}\\]>}\\]"), "{[<{[self.FUNC_CALL()}]>}]");
FilledString = Filler.FillEntryPoint(Settings, "html_plot - SR5/template_index.html", "html_plot - SR5/index.html");
